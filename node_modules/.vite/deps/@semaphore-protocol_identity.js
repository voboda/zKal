    ...
    (function() {
      ...
      Sha512.prototype.copyTo = function(hash2) {
        ...
        for (i = 0; i < attrs.length; ++i) {
          hash2[attrs[i]] = this[attrs[i]];
        }
        for (i = 0; i < this.blocks.length; ++i) {
          hash2.blocks[i] = this.blocks[i];
        }
      };
      ...
      HmacSha512.prototype.clone = function() {
        ...
        for (var i = 0; i < this.oKeyPad.length; ++i) {
          hash2.oKeyPad[i] = this.oKeyPad[i];
        }
        return hash2;
      };
...
// node_modules/@semaphore-protocol/identity/dist/index.mjs
var import_js_sha512 = __toESM(require_sha512(), 1);

// node_modules/@ethersproject/random/lib.esm/_version.js
var version = "random/5.7.0";
...
var c$1 = (0, _unstringify$1.default)(_$1.default);
...
var Identity = (
  /** @class */
  function() {
    function Identity2(identityOrMessage) {
      if (identityOrMessage === void 0) {
      ...
      if (!isJsonArray(identityOrMessage)) {
        var h = import_js_sha512.default.sha512(identityOrMessage).padStart(128, "0");
    ...
    Object.defineProperty(Identity2.prototype, "trapdoor", {
      /**
    ...
    Identity2.prototype.getTrapdoor = function() {
      return this._trapdoor;
    };
    Object.defineProperty(Identity2.prototype, "nullifier", {
      /**
    ...
    Identity2.prototype.getNullifier = function() {
      return this._nullifier;
    };
    Object.defineProperty(Identity2.prototype, "secret", {
      /**
    ...
    Identity2.prototype.getSecret = function() {
      return this._secret;
    };
    Object.defineProperty(Identity2.prototype, "commitment", {
      /**
    ...
    Identity2.prototype.getCommitment = function() {
      return this._commitment;
    };
    Identity2.prototype.toString = function() {
...
@semaphore-protocol/identity/dist/index.mjs:
  (**
  ...
  *)
*/
//# sourceMappingURL=@semaphore-protocol_identity.js.map
