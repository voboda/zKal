...
var Identity = /** @class */ (function () {
    ...
    function Identity(identityOrMessage) {
        ...
        if (!isJsonArray(identityOrMessage)) {
            var h = hash__default["default"].sha512(identityOrMessage).padStart(128, "0");
        ...
        this._trapdoor = bignumber.BigNumber.from(trapdoor).toBigInt();
        this._nullifier = bignumber.BigNumber.from(nullifier).toBigInt();
        this._secret = poseidon2_2([this._nullifier, this._trapdoor]);
        this._commitment = poseidon1_2([this._secret]);
    }
