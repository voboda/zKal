...
getDefaultExportFromCjs(buffer);
...
class Identity {
    ...
    constructor(privateKey) {
        ...
        if (privateKey) {
            ...
            if (isHexadecimal(privateKey, false)) {
                eddsa = new eddsaPoseidon.EdDSAPoseidon(hexadecimalToBuffer(privateKey));
            }
            else {
                eddsa = new eddsaPoseidon.EdDSAPoseidon(privateKey);
            }
        }
        else {
            eddsa = new eddsaPoseidon.EdDSAPoseidon();
            this._privateKey = eddsa.privateKey;
        }
        this._secretScalar = eddsa.secretScalar;
        this._publicKey = eddsa.publicKey;
        this._commitment = poseidon2_2(this._publicKey);
    }
    /**
    ...
    signMessage(message) {
        const privateKey = isHexadecimal(this.privateKey, false)
            ...
            : this.privateKey;
        return eddsaPoseidon.signMessage(privateKey, message);
    }
    /**
