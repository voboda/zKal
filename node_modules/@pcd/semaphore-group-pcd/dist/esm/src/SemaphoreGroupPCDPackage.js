...
import { SemaphoreGroupPCD, SemaphoreGroupPCDTypeName } from "./SemaphoreGroupPCD";
...
export async function prove(args) {
    ...
    const fullProof = await generateProof(identityPCD.claim.identity, deserializedGroup, args.externalNullifier.value, args.signal.value, {
