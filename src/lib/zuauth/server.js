...
import { ZKEdDSAEventTicketPCDPackage, ZKEdDSAEventTicketPCDTypeName } from "@pcd/zk-eddsa-event-ticket-pcd";
/**
 ...
 */
export async function authenticate(pcdStr, watermark, config) {
    ...
    if (publicKeys.length > 0 &&
        !publicKeys.find((pubKey) => isEqualEdDSAPublicKey(pubKey, pcd.claim.signer))) {
